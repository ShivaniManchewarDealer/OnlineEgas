...
public class DealerController {
	...
	@GetMapping(value="/viewDealer")
	public ResponseEntity<Dealer> viewDealer()
	{
		Dealer data=dealerService.getDealer();
		return new ResponseEntity<Dealer>(data,HttpStatus.OK);
